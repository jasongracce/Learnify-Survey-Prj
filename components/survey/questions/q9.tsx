...
import { Q9_OPTIONS, type FormState } from "../types";
...
export default function Q9({ form, setForm }: Props) {
  const { t } = useLanguage();
  const q = t.surveyPage.step3.q9;

  const toggle = (key: (typeof Q9_OPTIONS)[number]) => {
    setForm((prev) => {
